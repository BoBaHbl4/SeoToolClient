    ...
    var cwReports = function () {
        ...
        var datatable = $('#m_datatable_cw_reports').mDatatable({
            ...
            columns: [{
                ...
                width: 60,
                template: function (row) {
                    return '<a href="' + row.action + '" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Download Report"><i class="flaticon-download"></i></a>';
                }
            }]
        });
