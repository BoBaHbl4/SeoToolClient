var DatatableSSProjectsActive = function () {
    //== Private functions
    ...
    var ssProjects = function () {
        ...
        var listData = [
            {
                "project_id": 1,
                "project_name": "Geologix Some Name",
            ...
            {
                "project_id": 2,
                "project_name": "Repetwire Travel Blog",
            ...
            {
                "project_id": 3,
                "project_name": "Buzzworks Crossfire Technology",
        ...
        var datatable = $('#m_datatable_ss_projects_active').mDatatable({
            ...
            columns: [{
                ...
                template: function (row) {
                    var projectStatus = {
                        0: {'title': 'Activate Project', 'class': 'play', 'modal':'m_modal_project_activate'},
                        1: {'title': 'Stop Project', 'class': 'pause', 'modal':'m_modal_project_stop'}
                    };
                    ...
                    return '<a href="' + [row.control.edit_link] + '" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill m-badge--wide"><i class="la la-edit"></i></a>' +
                        '<a href="#" data-project-value="' + [row.project_id] + '" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill m-badge--wide m--margin-right-5 m--margin-left-5" title="'+ projectStatus[row.control.active].title +'" data-toggle="modal" data-target="#'+ projectStatus[row.control.active].modal +'"><i class="la la-'+ projectStatus[row.control.active].class +'"></i></a>' +
                        '<a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill m-badge--wide" title="Delete Project" data-toggle="modal" data-target="#m_modal_project_delete"><i class="la la-close"></i></a>';
                }
            }, {
                sortable: false,
                field: "reports",
        ...
        $('#m_form_ss_projects_active_search').on('keyup', function (e) {
...
var DatatableSSProjectsCompleted = function () {
    //== Private functions
    ...
    var ssProjects = function () {
        ...
        $('#m_form_ss_projects_completed_search').on('keyup', function (e) {
            datatable.search($(this).val().toLowerCase());
        }).val(query.generalSearch);
...
$(document).ready(function () {
    DatatableSSProjectsActive.init();
    DatatableSSProjectsCompleted.init();
});