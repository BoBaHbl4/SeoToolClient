var DatatableSJProjectsActive = function () {
    //== Private functions
    
    // sjProjects initializer
    var sjProjects = function () {
        ...
        var datatable = $('#m_datatable_sj_orders_active').mDatatable({
            ...
            layout: {
                ...
                class: 'm_datatable--seognal-sj-orders-active', // custom wrapper class
        ...
        $('#m_form_sj_orders_active_search').on('keyup', function (e) {
...
var DatatableSJProjectsComplete = function () {
    //== Private functions
    ...
    var sjProjects = function () {
        ...
        var datatable = $('#m_datatable_sj_orders_complete').mDatatable({
            // datasource definition
            data: {
                type: 'local',
                source: listData,
            ...
            layout: {
                theme: 'default', // datatable theme
                class: 'm_datatable--seognal-sj-orders-complete', // custom wrapper class
                scroll: false, // enable/disable datatable scroll both horizontal and vertical when needed.
                height: null, // datatable's body's fixed height
                footer: false // display/hide footer
            },
        ...
        $('#m_form_sj_orders_complete_search').on('keyup', function (e) {
            datatable.search($(this).val().toLowerCase());
        }).val(query.generalSearch);
...
$(document).ready(function () {
    DatatableSJProjectsActive.init();
    DatatableSJProjectsComplete.init();
});